class Manage::QuestionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @question.save
        ...
        format.html { redirect_to manage_account_exam_paper_questions_path(@current_account, @paper.exam_id, @paper), notice: 'Paper was successfully added.' }
        format.json { render :show, status: :created, location: manage_account_exam_paper_questions_path(@current_account, @paper.exam_id, @paper) }
      else
  ...
  def update
    respond_to do |format|
      if @question.update(question_params)
        format.html { redirect_to manage_account_exam_paper_questions_path(@current_account, @paper.exam_id, @paper), notice: 'Paper was successfully updated.' }
  ...
  def destroy
    @question.destroy
    respond_to do |format|
      format.html { redirect_to manage_account_exam_paper_questions_path(@current_account, @paper.exam_id, @paper), notice: 'Paper was successfully removed.' }
